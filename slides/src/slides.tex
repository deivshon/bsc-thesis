...
\begin{frame}
  ...
  Questo implica la necessità di centralizzare lo stato dell'applicazione:
  \vspace{3pt}
  \begin{itemize}
...
\begin{frame}
  ...
  Elm offre trade-off di nicchia, che lo hanno reso una scelta poco popolare rispetto ai grandi framework basati direttamente su JavaScript/TypeScript.\\

  Ciò nonostante, ha avuto influenze significative su altri strumenti, specialmente la Elm Architecture, che ha ispirato librerie come Redux, la soluzione più usata per la gestione dello stato in React per molto tempo e ancora oggi una delle più utilizzate. Ha inoltre contribuito al movimento complessivo verso linguaggi tipati staticamente anche nell'ambito frontend, dove per molto tempo la correttezza dei programmi non è stata considerata una priorità.
\end{frame}
